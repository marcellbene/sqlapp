...
namespace sqlapp.Services
{
    ...
    {
        private static string db_source = "benmarcll-sql-database-server.database.windows.net";
        private static string db_user = "benmarcll";
        private static string db_password = "Sqlpassword123";
        private static string db_database = "benmarcll-database";
